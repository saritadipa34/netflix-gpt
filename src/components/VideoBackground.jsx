...
const youtubeEmbedUrl = `https://www.youtube.com/embed/${videoId}?autoplay=1&mute=1`;
    ...
    return(
        <div className="relative z-10">
            ...
            src={trailerUrl} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share "></iframe>):
            (<p>Loading.....</p>)
            }
        </div>
    )
