...
const Header=()=>{
    return(
        <div className="w-full bg-gradient-to-b  from-black">
           ...
           <img className="h-20 w-45 relative " src="/logo.jpeg" alt="logo" />
            <div className="flex gap-5">
            <Button text={" English"} className={"bg-transparent px-4 h-10 py-1 rounded-3xl"} />
            <Button text={"Sign in"} className={"bg-white px-4 py-1 rounded-3xl"}/>
            </div>
            </div>
            <div className="absolute top-70 w-150 mx-auto left-0 right-0">
